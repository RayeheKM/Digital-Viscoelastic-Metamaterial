function Modeling(config, binaryStr, UseServer, modelingtype)
    ...
    if UseServer
        originalFile = fopen('/home/rkm41/DigitalMetamaterial/SampleConfig03.inp', 'r');
    else
        originalFile = fopen('C:\Users\BrinsonLab\Desktop\DigitalMetamaterial\Codes\SampleConfig03.inp', 'r');
    end
    ...
    % Copy the rest of the lines from line 114596 onwards
