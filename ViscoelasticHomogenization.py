"""Extract viscoelastic response from abaqus output ODB to CSV"""
import os
import sys
import numpy as np
...
if UseServer == '0':
    ...
    print('1')
    MyOdbAdress = '/home/rkm41/DigitalMetamaterial/' + 'Config' + str(configNumber) + '.odb'
    print(MyOdbAdress)
...
if UseServer == '0':
    ...
    MyText = '/home/rkm41/DigitalMetamaterial/' + 'Config' + str(configNumber) + '.txt'
...
with open(MyText, 'w') as file:
    ...
    for frame in MyStep.frames:
        ...
        for stress in MyStress.values:
            ...
            # print(stress.data[1])
            sum_I_Sxx = sum_I_Sxx + stress.conjugateData[1]
            # print(stress.conjugateData[1])
